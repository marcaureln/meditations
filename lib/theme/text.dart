...
TextTheme myTextTheme = TextTheme(
  headline1: GoogleFonts.ptSerif(fontSize: 99, fontWeight: FontWeight.w300, letterSpacing: -1.5),
  headline2: GoogleFonts.ptSerif(fontSize: 62, fontWeight: FontWeight.w300, letterSpacing: -0.5),
  headline3: GoogleFonts.ptSerif(fontSize: 49, fontWeight: FontWeight.w400),
  ...
  subtitle1: GoogleFonts.ptSerif(fontSize: 16, fontWeight: FontWeight.w400, letterSpacing: 0.15),
  subtitle2: GoogleFonts.ptSerif(fontSize: 14, fontWeight: FontWeight.w500, letterSpacing: 0.1),
